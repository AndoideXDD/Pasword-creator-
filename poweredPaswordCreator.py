...
if range(int(lenghpasword)-1)>=5:
	...
	if anwer=="Y":
		...
		for PasswordsLengh in range(1):
			generate.createDigitsBiggerThan5(fileNAme)
	...
	if input("\nIf you do not want more say (N) or (Y) if you want more:\n")
